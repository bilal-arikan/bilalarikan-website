...
<html lang="tr">
	...
	<title>Giriş &lsaquo; Bilal ARIKAN &#8212; WordPress</title>
	<meta name="robots" content="max-image-preview:large, noindex, noarchive">
<link rel="stylesheet" id="dashicons-css" href="./wp-includes/css/dashicons.min.css?ver=6.2" type="text/css" media="all">
<link rel="stylesheet" id="buttons-css" href="./wp-includes/css/buttons.min.css?ver=6.2" type="text/css" media="all">
<link rel="stylesheet" id="forms-css" href="./wp-admin/css/forms.min.css?ver=6.2" type="text/css" media="all">
<link rel="stylesheet" id="l10n-css" href="./wp-admin/css/l10n.min.css?ver=6.2" type="text/css" media="all">
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.2" type="text/css" media="all">
	<meta name="referrer" content="strict-origin-when-cross-origin">
		<meta name="viewport" content="width=device-width">
	<link rel="icon" href="./wp-content/uploads/2020/05/cropped-BA-tamam-4-1-32x32.png" sizes="32x32">
<link rel="icon" href="./wp-content/uploads/2020/05/cropped-BA-tamam-4-1-192x192.png" sizes="192x192">
<link rel="apple-touch-icon" href="./wp-content/uploads/2020/05/cropped-BA-tamam-4-1-180x180.png">
<meta name="msapplication-TileImage" content="./wp-content/uploads/2020/05/cropped-BA-tamam-4-1-270x270.png">
	</head>
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://128.199.36.238/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Giriş">
									<input type="hidden" name="redirect_to" value="http://128.199.36.238/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="./index.html">&larr; Bilal ARIKAN sitesine geri dön</a>		</p>
		<div class="privacy-policy-page-link"><a class="privacy-policy-link" href="./privacy-policy/index.html" rel="privacy-policy">Privacy Policy</a></div>	</div>
...
<script type="text/javascript" src="./wp-admin/js/password-strength-meter.min.js?ver=6.2" id="password-strength-meter-js"></script>
...
/* <![CDATA[ */
var userProfileL10n = {"user_id":"0","nonce":"34a985c92f"};
/* ]]> */
</script>
<script type="text/javascript" id="user-profile-js-translations">( function( domain, translations ) {
	...
	localeData[""].domain = domain;
	wp.i18n.setLocaleData( localeData, domain );
} )( "default", {"translation-revision-date":"2023-03-28 20:25:07+0000","generator":"GlotPress\/4.0.0-alpha.4","domain":"messages","locale_data":{"messages":{"":{"domain":"messages","plural-forms":"nplurals=2; plural=n > 1;","lang":"tr"},"Your new password has not been saved.":["Yeni parolanız kaydedilemedi."],"Hide":["Gizle"],"Show":["Göster"],"Confirm use of weak password":["Zayıf parola kullanmayı onayla"],"Hide password":["Parolayı gizle"],"Show password":["Parolayı göster"]}},"comment":{"reference":"wp-admin\/js\/user-profile.js"}} );</script>
<script type="text/javascript" src="./wp-admin/js/user-profile.min.js?ver=6.2" id="user-profile-js"></script>
